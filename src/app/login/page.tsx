    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Developer Profiles Portal</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <a
            href="/api/auth/login"
            className="flex items-center justify-center gap-3 w-full bg-gray-900 hover:bg-gray-800 text-white font-semibold py-3 px-6 rounded-xl transition-colors shadow-sm"
          >
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-xl">
            <p className="text-xs text-blue-700 text-center">
              <strong>Secure OAuth flow:</strong> You will be redirected to GitHub to authorize access. No passwords are stored.
            </p>
          </div>
        </div>
